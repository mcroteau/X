...
public class CommonUtilities {
	...
	public void write(CommonsMultipartFile file, String imageDirectory, String fileName) {
	...
	private long getDateFormatted(Calendar cal) {
        DateFormat df = new SimpleDateFormat(ApplicationConstants.DATE_SEARCH_FORMAT);
